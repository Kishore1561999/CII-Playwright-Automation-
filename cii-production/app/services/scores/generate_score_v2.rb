module Scores
    class GenerateScoreV2 < ApplicationService
      ...
      def perform
        ...
        categories = ApplicationRecord::CATEGORY_WISE_QUESTION_NO_2
        total_categories_count = ApplicationRecord::CATEGORY_WISE_QUESTION_NO_2.count
        ...
        ActiveRecord::Base.transaction do
          categories.each do |category|
            ...
            category.each do |question_code|
              ...
              when "hr_01", "csr_02", "em_04", "cg_08", "rm_07", "hr_08"
              ...
              when "cg_02"
                if answers[:cg_02].present?
                  ...
                  when "Chair is Independent director"
                    local_score += 100
                  when "Chair is a non-independent non-executive but no lead independent chair is appointed"
                    local_score += 30
                  when "Chair is an executive director"
                    local_score += 10
                  when "Not applicable"
              ...
              when "be_01"
                if answers[:be_01] == "Yes, the organization has a code of conduct/ethics policy and it is publicly available. Please provide the weblink"
                  local_score += 100
                elsif answers[:be_01] == "Yes, the organization has a code of conduct/ethics policy, but it is not publicly available"
                  local_score += 70
              ...
              when "be_05"
                if answers[:be_05] == "Yes, the organization has an ethics and compliance officer (Please give name and designation)"
                  local_score += 100
                elsif answers[:be_05] == "It is managed by HR"
                  local_score += 50
                elsif answers[:be_05] == "It is managed by another department (Please mention)"
                  local_score += 50
                elsif answers[:be_05] == "Not applicable"
                  if answers[:be_05_vb_option6_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "be_03"
                if answers[:be_03] == "Information Available"
                  if answers[:be_03_option1_checkbox1].present?
                    local_score += 20
                  end
                  if answers[:be_03_option1_checkbox2].present?
                    if answers[:be_03_option12_radio1] == "Annually/ Bi-Annually"
                      local_score += 40
                    elsif answers[:be_03_option12_radio1] == "Every 2-3 years"
                      local_score += 30
                    else
                      local_score += 10
                    end
                  end
                  if answers[:be_03_option1_checkbox3].present?
                    local_score += 20
                  end
                  if answers[:be_03_option1_checkbox4].present?
                    local_score += 20
                  end
              ...
              when "be_06"
                if answers[:be_06] == "Yes, the organization has a whistle-blowing mechanism, which is available to"
                  checkbox_scores = {
                    be_06_option1_checkbox1: 15,
                    be_06_option1_checkbox2: 20,
                    be_06_option1_checkbox3: 15,
                    be_06_option1_checkbox4: 20,
                    be_06_option1_checkbox5: 15,
                    be_06_option1_checkbox6: 15
                  }

                  checkbox_scores.each do |checkbox_key, score|
                    if answers[checkbox_key].present?
                      local_score += score
                    end
                  end
                elsif answers[:be_06] == "Not applicable"
                  if answers[:be_06_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              when "td_01"
                if answers[:td_01] == "Yes, the organisation has a ESG Data management system and the system has following features"
                  if answers[:td_01_option1_checkbox1].present?
                    local_score += 20
                  end
                  if answers[:td_01_option1_checkbox2].present?
                    local_score += 20
                  end
                  if answers[:td_01_option1_checkbox3].present?
                    local_score += 20
                  end
                  if answers[:td_01_option1_checkbox4].present?
                    local_score += 20
                  end
                  if answers[:td_01_option1_checkbox5].present?
                    local_score += 20
                  end
                elsif answers[:td_01] == "Not applicable"
                  if answers[:td_01_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "td_02"
                if answers[:td_02] == "Information available"
                  td_option_score_one = 0
                  if answers[:td_02_option11_radio1] == "an Integrated Report"
                    td_option_score_one = 100
                  elsif answers[:td_02_option11_radio1] == "a section in the Annual Report"
                    td_option_score_one = 100
                  elsif answers[:td_02_option11_radio1] == "a section on company website"
                    td_option_score_one = 100
                  elsif answers[:td_02_option11_radio1] == "a Sustainability Report/BRSR"
                    td_option_score_one = 100
                  end
                  td_option_score_two = 0
                  if answers[:td_02_option12_checkbox1].present?
                    td_option_score_two += 0.4
                  end
                  if answers[:td_02_option12_checkbox2].present?
                    td_option_score_two += 0.3
                  end
                  if answers[:td_02_option12_checkbox3].present?
                    td_option_score_two += 0.3
                  end
                  local_score +=  td_option_score_two * td_option_score_one
                end
              when "td_03"
                if answers[:td_03] == "More than 50%"
                  local_score += 100
                elsif answers[:td_03] == "25–50%"
                  local_score += 60
                elsif answers[:td_03] == "Below 25%"
                  local_score += 40
                elsif answers[:td_03] == "Not applicable"
                  if answers[:td_03_vb_option7_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              #     if answers[:cg_08_option1_checkbox1].present?
              #       if answers[:cg_08_option11_number1].to_i <= 50
              #         local_score += 100
              #       elsif answers[:cg_08_option11_number1].to_i <= 100 && answers[:cg_08_option11_number1].to_i > 50
              #         local_score += 50
              #       end
              #     end
              #   end
              when "td_04"
                if answers[:td_04] == 'The sustainability report is'
                  if answers[:td_04_option1_radio] == 'Internally assured'
                    local_score += 25
                  elsif answers[:td_04_option1_radio] == 'Externally assured in line with international standards (such as AA1000 and ISAE 3000)'
                    local_score += 50
                    if answers[:td_04_option12_checkbox1].present?
                      local_score += 10
                    end
                    if answers[:td_04_option12_checkbox2].present?
                      local_score += 15
                    end
                    if answers[:td_04_option12_checkbox3].present?
                      local_score += 15
                    end
                    if answers[:td_04_option12_checkbox4].present?
                      local_score += 10
                    end
                  end
              ...
              when "hr_02"
                if answers[:hr_02] == "The organisation communicates is commitment to protecting human rights in following ways"
                  if answers[:hr_02_option1_checkbox1].present?
                    if answers[:hr_02_option11_radio1] == "Organisation has a human rights policy and it is publicly available. Please provide link to the webpage"
                      local_score += 60
                    elsif answers[:hr_02_option11_radio1] == "Organisation has a human rights policy but it is not publicly available"
                      local_score += 30
                    end
                  end
                  if answers[:hr_02_option1_checkbox2].present?
                    checkbox_present = false
                    [1, 2, 3, 4].each do |checkbox_number|
                      checkbox_key = "hr_02_option12_checkbox#{checkbox_number}"
                      if answers[checkbox_key].present?
                        checkbox_present = true  
                        break 
                      end
                    end
                    local_score += 40 if checkbox_present
                  end
                elsif answers[:hr_02] == "Not applicable"
                  if answers[:hr_02_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "ohs_06"
                if answers[:ohs_06] == "There have been following number of permanent disabilties in the last financial year"
                ...
                elsif answers[:ohs_06] == "There have been no permanent disabilities in the last financial year"
                    local_score += 100
              ...
              when "ohs_07"
                if answers[:ohs_07] == "Number of fatalities provided"
                  if answers[:ohs_07_option1_number1].present?
                    if answers[:ohs_07_option1_number1].to_i == 0
                      local_score += 50
                    else
                      local_score += 0
                    end
                  end
                  if answers[:ohs_07_option1_number2].present?
                    if answers[:ohs_07_option1_number2].to_i == 0
                      local_score += 50
                    else
                      local_score += 0
                    end
                  end
                elsif answers[:ohs_07] == "Not applicable"
                  if answers[:ohs_07_vb_option3_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              when "hr_06"
                if answers[:hr_06] == "Cases of human rights violation filed in the last financial year"
                  (1..5).each do |option|
                    if answers[('hr_06_option1_radio' + option.to_s).to_sym].present?
                      if answers[('hr_06_option1_radio' + option.to_s).to_sym] == "Data available"
                        if answers[('hr_06_option1' + option.to_s + '_number1').to_sym].present?
                          local_score += get_hr_06_sub_value(answers[('hr_06_option1' + option.to_s + '_number2').to_sym].to_f)
                        end
              ...
              when "hr_09"
                if answers[:hr_09] == "Percentage indicated for permanent & other than permanent workforce separately"
                  if answers[:hr_09_option1_checkbox1].present? && answers[:hr_09_option11_number1].present? && (answers[:hr_09_option11_number1].to_f > 0)
                    local_score += get_hr_08_sub_value(answers[:hr_09_option11_number1].to_f)
                  end
                  if answers[:hr_09_option1_checkbox2].present? && answers[:hr_09_option12_number1].present? && (answers[:hr_09_option12_number1].to_f > 0)
                    local_score += get_hr_08_sub_value(answers[:hr_09_option12_number1].to_f)
                  end
                  if answers[:hr_09_option1_checkbox4].present? && answers[:hr_09_option14_number1].present? && (answers[:hr_09_option14_number1].to_f > 0)
                    local_score += get_hr_08_sub_value(answers[:hr_09_option14_number1].to_f)
                  end
                  if answers[:hr_09_option1_checkbox5].present? && answers[:hr_09_option15_number1].present? && (answers[:hr_09_option15_number1].to_f > 0)
                    local_score += get_hr_08_sub_value(answers[:hr_09_option15_number1].to_f)
                  end
                  ...
                  if answers[:hr_09_option2_checkbox1].present? && answers[:hr_09_option21_number1].present? && (answers[:hr_09_option21_number1].to_f > 0)
                    local_score += get_hr_08_sub_value(answers[:hr_09_option21_number1].to_f)
                  end
                  if answers[:hr_09_option2_checkbox2].present? && answers[:hr_09_option22_number1].present? && (answers[:hr_09_option22_number1].to_f > 0)
                    local_score += get_hr_08_sub_value(answers[:hr_09_option22_number1].to_f)
                  end
              ...
              when "hr_10"
                if answers[:hr_10] == "Yes the organisation has employed following number of differently abled employees & workers, and takes measures to improve their accessibility to office/premises"
                  if answers[:hr_10_option1_checkbox2].present? && answers[:hr_10_vb_option4_radio] == "Measures are acceptable"
                    local_score += 100
                  end
                elsif answers[:hr_10] == "Not applicable"
                  if answers[:hr_10_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "hr_11"
                if answers[:hr_11] == "Percentage indicated"
                  if answers[:hr_11_option1_checkbox1].present? && answers[:hr_11_option11_number1].present? && (answers[:hr_11_option11_number1].to_f > 0)
                    local_score += get_hr_10_sub_value(answers[:hr_11_option11_number1].to_f)
                  end
                  if answers[:hr_11_option1_checkbox2].present? && answers[:hr_11_option12_number1].present? && (answers[:hr_11_option12_number1].to_f > 0)
                    local_score += get_hr_10_sub_value(answers[:hr_11_option12_number1].to_f)
                  end
                  if answers[:hr_11_option1_checkbox4].present? && answers[:hr_11_option14_number1].present? && (answers[:hr_11_option14_number1].to_f > 0)
                    local_score += get_hr_10_sub_value(answers[:hr_11_option14_number1].to_f)
                  end
                  if answers[:hr_11_option1_checkbox5].present? && answers[:hr_11_option15_number1].present? && (answers[:hr_11_option15_number1].to_f > 0)
                    local_score += get_hr_10_sub_value(answers[:hr_11_option15_number1].to_f)
                  end
                elsif answers[:hr_11] == "Gender segregated data not available. However, data available on percentage of total employees covered and total workers covered"
                  if answers[:hr_11_option2_checkbox1].present? && answers[:hr_11_option21_number1].present? && (answers[:hr_11_option21_number1].to_f > 0)
                    local_score += get_hr_10_sub_value(answers[:hr_11_option21_number1].to_f)
                  end
                  if answers[:hr_11_option2_checkbox2].present? && answers[:hr_11_option22_number1].present? && (answers[:hr_11_option22_number1].to_f > 0)
                    local_score += get_hr_10_sub_value(answers[:hr_11_option22_number1].to_f)
                  end
                elsif answers[:hr_11] == "Not applicable"
                  if answers[:hr_11_vb_option5_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "hr_12"
                if answers[:hr_12] == "Information Available"
                  if answers[:hr_12_option1_checkbox1].present?
                    local_score += 20
                  end
                  row_number3 = answers[("hr_12_table1_row1_number3").to_sym] #2024
                  row_number2 = answers[("hr_12_table1_row1_number2").to_sym] #2023
                  row_number1 = answers[("hr_12_table1_row1_number1").to_sym] #2022

                  if row_number2.present? && row_number2.to_i > 0
                    if row_number1.to_i == 0 && row_number3.to_i > 0
                      row_number1 = row_number2.to_f
                    end
                  end
                  idfs_values = { :i => 80, :d => 0, :f => 50 }
                  if row_number2.present? && row_number2.to_i > 0 && row_number1.to_i > 0 && row_number3.to_i > 0
                    trend_value = find_trend_type(row_number3.to_f, row_number1.to_f)
                    local_score += idfs_values[trend_value.to_sym]
                  end
                 
                elsif answers[:hr_12] == "Not applicable"
                  if answers[:hr_12_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "hc_02"
                if answers[:hc_02] == "Information Available"
                  ...
                  if answers[:hc_02_option1_checkbox5].present? && answers[:hc_02_option15_number1].present? && (answers[:hc_02_option15_number1].to_f > 5)
                    local_score += get_hc_02_03_sub_value(answers[:hc_02_option15_number1].to_f)
                  end
              ...
              when "hc_03"
                if answers[:hc_03] == "Percentage of employees/workers who received performance & career development review"
                  ...
                  if answers[:hc_03_option1_checkbox5].present? && answers[:hc_03_option15_number1].present? && (answers[:hc_03_option15_number1].to_f > 5)
                    local_score += get_hc_02_03_sub_value(answers[:hc_03_option15_number1].to_f)
                  end
              ...
              when "be_02", "be_07", "rm_05", "rm_03", "ohs_08", "em_10", "sc_01", "hr_03", "hr_04"
              ...
              when "hr_07"
                if answers[:hr_07] == "Yes there is a mechanism in place, and details are available"
                  if answers[:hr_07_option1_checkbox1].present?
                    local_score += 20
                  end
                  if answers[:hr_07_option1_checkbox2].present?
                    (1..8).each do |question_number|
                      checkbox_key = "hr_07_option12_checkbox#{question_number}".to_sym
                      # Check if the checkbox is present and if there is a response in the textbox
                      if answers[checkbox_key].present?
                        # Increment the total score by 10 for each valid response
                        local_score += 10
                      end
                    end
                  end
                elsif answers[:hr_07] == "Yes there is a mechanism in place, but no other details are available"
                  local_score += 20
                elsif answers[:hr_07] == "Not applicable"
                  if answers[:hr_07_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              when "bd_04"
                if answers[:bd_04] == "Information Available"
                  ...
                  if answers[:bd_04_vb_option1_checkbox2].present?
                    if answers[:bd_04_vb_option12_radio] == "All measures are acceptable"
                      local_score += 50
                    elsif answers[:bd_04_vb_option12_radio] == "2 measures are acceptable"
                      local_score += 30
                    elsif answers[:bd_04_vb_option12_radio] == "Only 1 measure is acceptable"
                      local_score += 20
                    end
                  end
              ...
              when "td_05"
                if answers[:td_05_vb_option1_radio].present?
                  if answers[:td_05_vb_option1_radio] == "All material issues identified have KPIs and Targets"
                    local_score += 100
                  elsif answers[:td_05_vb_option1_radio] == "Most material issues identified have KPIs and Targets"
                    local_score += 75
                  elsif answers[:td_05_vb_option1_radio] == "Some material issues identified have KPIs and Targets"
                    local_score += 50
                  elsif answers[:td_05_vb_option1_radio] == "Material issues identified but no details for any available"
                    local_score += 25
                  end
                elsif answers[:td_05] == "Not applicable"
                  if answers[:td_05_vb_option5_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "td_06"
                if answers[:td_06_vb_option1_radio].present?
                  if answers[:td_06_vb_option1_radio] == "Financial implication provided for all identified material issues"
                    local_score += 100
                  elsif answers[:td_06_vb_option1_radio] == "Financial implication provided for 50% identified material issues"
                    local_score += 60
                  end
                elsif answers[:td_06] == "Not applicable"
                  if answers[:td_06_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              when "csr_04"
                Rollbar.info("CSR_O4 #{answers[:csr_04]}")
                if answers[:csr_04] == "Information available"
                  (1..3).each do |checkbox_number|
                    checkbox_key = "csr_04_vb_option1_checkbox#{checkbox_number}".to_sym
                    radio_key = "csr_04_vb_option1#{checkbox_number}_radio".to_sym

                    Rollbar.info("CSR_O4_check_key #{checkbox_key} ---- #{radio_key}")
                    
                    next unless answers[checkbox_key].present?

                    Rollbar.info("CSR_O4_answers #{answers[radio_key]}")
                
                    case answers[radio_key]
                    when "Output, outcome and impact mentioned are relevant to the CSR activity, impacts are qualitative and quantitative in nature"
                      local_score += 30
                      check_csr_value += 30
                    when "Output, outcome and impact mentioned are relevant to the CSR activity, impacts are only qualitative in nature"
                      local_score += 25
                      check_csr_value += 25
                    when "No impacts mentioned, but output and outcome mentioned are relevant to the CSR activity and are qualitative and quantitative in nature"
                      local_score += 15
                      check_csr_value += 15
                    when "No impacts mentioned, but output and outcome mentioned are relevant to the CSR activity and are qualitative in nature"
                      local_score += 10
                      check_csr_value += 10
                    when "Only output mentioned and they are relevant to the CSR activity"
                      local_score += 5
                      check_csr_value += 5
                    end
                  end
                  Rollbar.info("CSR_O4 #{check_csr_value}")
              ...
              when "rm_07"
                if answers[:rm_07] == "Yes, the organisation has been involved in a crisis situation"
                  if answers[:rm_07_vb_option1_radio].present?
                    if answers[:rm_07_vb_option1_radio] == "The case will affect less than 500 individuals in less severe way or will have a medium term effect on environment/community/disablement"
                      local_score += 10
                    elsif answers[:rm_07_vb_option1_radio] == "The case will affect less than 100 indivduals in a less severe way or temporary effect on environment/community"
                      local_score += 20
                    elsif answers[:rm_07_vb_option1_radio] == "No damage done"
                      local_score += 30
                    end
                  end

                  if answers[:rm_07_vb_option1_radio1].present?
                    if answers[:rm_07_vb_option1_radio1] == "The company took immediate and sufficient measures to contain the damage/ Or no-damage done"
                      local_score += 40
                    elsif answers[:rm_07_vb_option1_radio1] == "The company tool insufficient or delayed measures"
                      local_score += 20
                    end
                  end

                  if answers[:rm_07_vb_option1_radio2].present?
                    if answers[:rm_07_vb_option1_radio2] == "The company pro-actively communicated with the stakeholders on the case"
                      local_score += 30
                    elsif answers[:rm_07_vb_option1_radio2] == "Company only reacted to the case on need to know basis"
                      local_score += 10
                    end
                  end
                else
              ...
              when "rm_04"
                rm_04_temp_score = 0
                if answers[:rm_04] == "Yes, the organization identifies significant risks and develops mitigation strategy for them"
                  if answers[:rm_04_vb_option1_radio1].present?
                    if answers[:rm_04_vb_option1_radio1] == "Impacts on business are well defined for two or more risks"
                      rm_04_temp_score += 30
                    elsif answers[:rm_04_vb_option1_radio1] == "Impacts on business are well defined for only one risk"
                      rm_04_temp_score += 15
                    end
                  end
                  if answers[:rm_04_vb_option1_radio2].present?
                    if answers[:rm_04_vb_option1_radio2] == "Coherent strategies and mitigation actions defined to deal with the all risks that are identified"
                      rm_04_temp_score += 30
                    elsif answers[:rm_04_vb_option1_radio2] == "Coherent strategies and mitigation actions defined to deal with the less than two risks that are identified"
                      rm_04_temp_score += 15
                    end
                  end
                  if answers[:rm_04_vb_option1_radio3].present?
                    if answers[:rm_04_vb_option1_radio3] == "Financial impacts are well defined for two or more risks"
                      rm_04_temp_score += 40
                    elsif answers[:rm_04_vb_option1_radio3] == "Financial impacts are well defined for only one risk"
                      rm_04_temp_score += 20
                    end
                  end
                  local_score += (rm_04_temp_score > 100) ? 100 : rm_04_temp_score
                elsif answers[:rm_04] == "Not applicable"
                  if answers[:rm_04_vb_option4_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "be_04"
                if answers[:be_04] == "Information available"
                  (1..5).each do |option|
                    if answers[('be_04_table1_row' + option.to_s + '_percentage1').to_sym].present? && (answers[('be_04_table1_row' + option.to_s + '_percentage1').to_sym].to_f > 0)
                      local_score += answers[('be_04_table1_row' + option.to_s + '_percentage1').to_sym].to_f * 0.2
                    end
                  end
                elsif answers[:be_04] == "Not applicable"
                  if answers[:be_04_vb_option3_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              when "be_08"
                if answers[:be_08] == "Number of cases reported" && answers[:be_08_option1_number1].present? && (answers[:be_08_option1_number1].to_i == 0)
                  local_score += 100
                elsif answers[:be_08] == "Not applicable"
                  if answers[:be_08_vb_option5_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              ...
              when "ohs_03", "ohs_04", "ohs_05"
                if answers[question_code.to_sym] == "Information available"
                  ...
                  (1..2).each do |option|
                    ...
                    row_number1 = answers[(question_code + "_table1_row" + option.to_s + "_number1").to_sym]
                    row_number2 = answers[(question_code + "_table1_row" + option.to_s + "_number2").to_sym]
                    row_number3 = answers[(question_code + "_table1_row" + option.to_s + "_number3").to_sym]
                  
                    if row_number3.to_i == 0 && row_number1.to_i == 0 && row_number2.to_i == 0
                      local_score += 40
                    elsif row_number3.present? && row_number3.to_i == 0 && row_number1.present? && row_number1.to_i == 0
                      local_score += 40
                    elsif row_number3.present? && row_number3.to_f >= 0
                      if row_number1.present? && row_number1.to_f >= 0
                        trend_value = find_trend_type(row_number3.to_f, row_number1.to_f)
                        local_score += idf_values[trend_value.to_sym]
                      elsif row_number2.present? && row_number2.to_f >= 0 && !(row_number3.to_i == 0 && row_number2.to_i == 0)
                        trend_value = find_trend_type(row_number3.to_f, row_number2.to_f)
                        local_score += idf_values[trend_value.to_sym]
                      elsif row_number3.to_i == 0 && row_number2.present? && row_number2.to_i == 0
                        local_score += 40
                      end
                    end
              ...
              when "pr_08"
                if answers[:pr_08] == "The senior most person responsible for cybersecurity is"
                  if answers[:pr_08_option1_chackbox1].present? && answers[:pr_08_option1_chackbox1] == "At Board level"
                    local_score += 50
                  end
                  if answers[:pr_08_option1_chackbox2].present? && answers[:pr_08_option1_chackbox2] == "At Management level"
                    if answers[:pr_08_option12_radio1].present?
                      case answers[:pr_08_option12_radio1].to_s
                      when "Chief Information security officer/ Chief security architect/ Chief Security officer"
                        local_score += 50
                      when "Chief Technology officer/ Chief information officer or similar"
                        local_score += 30
                      when "CEO/COO/CRO/CFO or similar whose defined roles include cybersecurity"
                        local_score += 10
                      end
                    end 
                  end
                elsif answers[:pr_08] == "Not applicable"
                  if answers[:pr_08_vb_option3_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "pr_09"
                if answers[:pr_09] == "Yes, the organisation has put in place following procedures"
                    checkboxes = [
                      :pr_09_vb_option1_checkbox1,
                      :pr_09_vb_option1_checkbox2,
                      :pr_09_vb_option1_checkbox3,
                      :pr_09_vb_option1_checkbox4,
                      :pr_09_vb_option1_checkbox5
                    ]
                    checkboxes_present_count = checkboxes.count { |checkbox| answers[checkbox].present? }
                    local_score += 100 if checkboxes_present_count == 4
                    local_score += 75 if checkboxes_present_count == 3
                    local_score += 50 if checkboxes_present_count == 2
                    local_score += 25 if checkboxes_present_count == 1
                elsif answers[:pr_09] == "Not applicable"
                  if answers[:pr_09_vb_option3_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "pr_10"
                if answers[:pr_10] == "Information available"
                  if answers[:pr_10_vb_option1_radio] == "Business continuity plan for cyber-securty risks"
                    checkboxes = [
                      :pr_10_vb_option1_checkbox1,
                      :pr_10_vb_option1_checkbox2,
                      :pr_10_vb_option1_checkbox3,
                      :pr_10_vb_option1_checkbox4,
                      :pr_10_vb_option1_checkbox5
                    ]
                    
                    checkboxes_present_count = checkboxes.count { |checkbox| answers[checkbox].present? }
                    local_score += 20 * checkboxes_present_count
                  end
                elsif answers[:pr_10] == "Not applicable"
                  if answers[:pr_10_vb_option3_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
              when "pr_11"
                if answers[:pr_11] == "There have been no incidents of breaches of cyber-security"
                  local_score += 100
                elsif answers[:pr_11] == "Not applicable"
                  if answers[:pr_11_vb_option3_radio] == "Reason provided are justified and it is not applicable"
                    non_countable_questions_count += 1
                    question_not_applicable_status = 1
                  end
                end
                ...
                if answers[:hr_05] == "Following systems are in place to ensure effective communication & implementation of HR Policies"
                  if answers[:hr_05_option1_checkbox1].present?
                    if answers[:hr_05_option111_number1].present? && (answers[:hr_05_option111_number1].to_f > 0)
                      local_score += (answers[:hr_05_option111_number1].to_f * 0.2)
                    end
                    if answers[:hr_05_option112_number1].present? && (answers[:hr_05_option112_number1].to_f > 0)
                      local_score += (answers[:hr_05_option112_number1].to_f * 0.2)
                    end
                  end
              ...
              unless ['cg_08', 'rm_07'].include?(question_code)
